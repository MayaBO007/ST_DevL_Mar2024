...
function timeline() {
    platform.getAllSessions().then((data) => {
        getIndexSessionData(data).then((indexI) => {
            ...
            else if ((updatedDates.fullDate.getDate() == updatedDates.yesterdayPlusOne.getDate()) || (studySessionData.subId == "64eba909d2c8fb647d0adc41")) { //|| yesterdayPlusOne.getDate() - fullDate.getDate() > 25 ) {)
